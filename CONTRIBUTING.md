...
3. If you've changed APIs, update the documentation and API Schema definitions (see [development docs](https://github.com/solvio/solvio/blob/master/docs/DEVELOPMENT.md#api-changes))
...
## Report bugs using GitHub's [issues](https://github.com/solvio/solvio/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/solvio/solvio/issues/new/choose); it's that easy!
