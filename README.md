...
<table>
    <tr>
        <td>
            <img height="300px" style="" src="https://solvio.tech/content/images/text_search.png">
        </td>
        <td>
            <img height="300px" src="https://solvio.tech/content/images/image_search.png">
        </td>
        <td>
            <img height="300px" src="https://solvio.tech/content/images/recommendations.png">
        </td>
    </tr>
    <tr>
        <td>
...
<table align="center">
    <tr>
        <td>
            <img height="300px" src="https://solvio.tech/content/images/chat_bots.png">
        </td>
        <td>
            <img height="300px" src="https://solvio.tech/content/images/matching_engines.png">
        </td>
    </tr>
    <tr>
        <td>
...
Solvio supports key-value payload associated with vectors. Not only stores payload but also allows filter results based on payload values.
