...
function help {
	...
	--request-timeout|--timeout REQUEST_TIMEOUT
	        Request timeout for Solvio client (in seconds; float-point value)
	--connection-timeout CONNECTION_TIMEOUT
	        Connection timeout for Solvio client (in seconds; float-point value)
	--api-key API_KEY
	        API key for Solvio client
