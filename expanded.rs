...
pub mod proto {
    ...
    pub mod solvio_client {
        ...
        #[automatically_derived]
        #[allow(unused_qualifications)]
        impl<T: ::core::fmt::Debug> ::core::fmt::Debug for SolvioClient<T> {
            fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
                match *self {
                    SolvioClient {
                        inner: ref __self_0_0,
                        ...
                        let debug_trait_builder =
                            &mut ::core::fmt::Formatter::debug_struct(f, "SolvioClient");
                        let _ = ::core::fmt::DebugStruct::field(
                            debug_trait_builder,
                            "inner",
                            &&(*__self_0_0),
        ...
        #[automatically_derived]
        #[allow(unused_qualifications)]
        impl<T: ::core::clone::Clone> ::core::clone::Clone for SolvioClient<T> {
            #[inline]
            fn clone(&self) -> SolvioClient<T> {
                match *self {
                    SolvioClient {
                        inner: ref __self_0_0,
                    } => SolvioClient {
    ...
    pub mod solvio_server {
        ...
        #[automatically_derived]
        #[allow(unused_qualifications)]
        impl<T: ::core::fmt::Debug + Solvio> ::core::fmt::Debug for SolvioServer<T> {
            fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
                match *self {
                    SolvioServer {
                        inner: ref __self_0_0,
                        ...
                        let debug_trait_builder =
                            &mut ::core::fmt::Formatter::debug_struct(f, "SolvioServer");
                        let _ = ::core::fmt::DebugStruct::field(
                            debug_trait_builder,
                            "inner",
                            &&(*__self_0_0),
