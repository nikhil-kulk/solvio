...
fn configure_validation(builder: Builder) -> Builder {
    builder
        ...
        .validates(&[
            ...
            ("DissimilaritySearchBatchPoints.dissimilarity_search_points", ""),
        ...
        .validates(&[
            ...
            ("DissimilaritySearchPointsInternal.dissimilarity_search_points", ""),
            ("DissimilaritySearchBatchPointsInternal.collection_name", "length(min = 1, max = 255)"),
            ("DissimilaritySearchBatchPointsInternal.dissimilarity_search_points", ""),
