...
use super::solvio::{CompressionRatio, GeoLineString, GroupId};
        ...
        match value {
            ...
            segment::types::QuantizationConfig::Product(segment::types::ProductQuantization {
                ...
                quantization: Some(super::solvio::quantization_config::Quantization::Product(
                    super::solvio::ProductQuantization {
...
impl TryFrom<QuantizationConfig> for segment::types::QuantizationConfig {
    ...
    fn try_from(value: QuantizationConfig) -> Result<Self, Self::Error> {
        ...
        match value {
            super::solvio::quantization_config::Quantization::Scalar(config) => {
                Ok(segment::types::ScalarQuantizationConfig {
                    r#type: match crate::grpc::solvio::QuantizationType::from_i32(config.r#type) {
                        None => {
                            return Err(Status::invalid_argument(
                                "Error converting quantization type: None",
                            ));
                        }
                        Some(crate::grpc::solvio::QuantizationType::UnknownQuantization) => {
                            return Err(Status::invalid_argument(
                                "Error converting quantization type: UnknownQuantization",
                            ));
                        }
                        Some(crate::grpc::solvio::QuantizationType::Int8) => {
                            segment::types::ScalarType::Int8
                        }
                    },
                    quantile: config.quantile,
