...
use super::solvio::{GeoPoint, NamedVectors};
...
impl Validate for crate::grpc::solvio::update_vectors_config::Config {
    fn validate(&self) -> Result<(), ValidationErrors> {
        use crate::grpc::solvio::update_vectors_config::Config;
        match self {
            Config::Params(params) => params.validate(),
            Config::ParamsMap(params_map) => params_map.validate(),
        }
