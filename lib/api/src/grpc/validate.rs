...
impl Validate for crate::grpc::solvio::AbortShardTransfer {
    fn validate(&self) -> Result<(), ValidationErrors> {
        validate_shard_different_peers(
            self.from_peer_id,
            self.to_peer_id,
...
impl Validate for super::solvio::vectors::VectorsOptions {
    fn validate(&self) -> Result<(), ValidationErrors> {
        match self {
            super::solvio::vectors::VectorsOptions::Vector(v) => v.validate(),
            super::solvio::vectors::VectorsOptions::Vectors(v) => v.validate(),
        }
    }
}

impl Validate for super::solvio::query_enum::Query {
    fn validate(&self) -> Result<(), ValidationErrors> {
        match self {
...
impl Validate for super::solvio::query::Variant {
    fn validate(&self) -> Result<(), ValidationErrors> {
        match self {
...
impl Validate for super::solvio::vector_input::Variant {
    fn validate(&self) -> Result<(), ValidationErrors> {
        match self {
...
impl Validate for super::solvio::expression::Variant {
    fn validate(&self) -> Result<(), ValidationErrors> {
        match self {
...
impl Validate for super::solvio::payload_index_params::IndexParams {
    fn validate(&self) -> Result<(), ValidationErrors> {
        match self {
...
impl Validate for super::solvio::IntegerIndexParams {
    fn validate(&self) -> Result<(), ValidationErrors> {
        let super::solvio::IntegerIndexParams {
            lookup,
            range,
            is_principal: _,
            on_disk: _,
