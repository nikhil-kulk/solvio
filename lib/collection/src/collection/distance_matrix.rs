...
impl From<CollectionSearchMatrixResponse> for api::grpc::solvio::SearchMatrixPairs {
    fn from(response: CollectionSearchMatrixResponse) -> Self {
...
impl From<CollectionSearchMatrixResponse> for api::grpc::solvio::SearchMatrixOffsets {
    fn from(response: CollectionSearchMatrixResponse) -> Self {
