...
impl<'s> SegmentHolder {
            ...
            for segment_point in segment_points {
                ...
                match latest_points.entry(segment_point) {
                    ...
                    Entry::Occupied(mut entry) if entry.get().0 < point_version => {
                        ...
                        // Mark other point for deletion
                        to_delete
                            .entry(old_segment_id)
                            .or_default()
                            .push(segment_point);
                    }
                    // Point we have seen before is equal or newer, mark this point for deletion
                    Entry::Occupied(_) => {
                        to_delete
                            .entry(*segment_id)
                            .or_default()
    ...
    /// See: <https://github.com/solvio/solvio/pull/5956>
    ///
    ...
    /// See: <https://github.com/solvio/solvio/pull/5528>
    ///
    ...
    /// be done explicitly. `save_version` must be true for the segment to be loaded when Solvio
    /// restarts.
...
mod tests {
    ...
    ///
    /// Before <https://github.com/solvio/solvio/pull/4060> the copy and delete operation to move a
    ...
    ///
    /// See: <https://github.com/solvio/solvio/pull/5585>
    #[tokio::test]
