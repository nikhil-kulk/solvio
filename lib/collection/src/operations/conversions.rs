        ...
        api::grpc::solvio::CollectionInfo {
            ...
            config: Some(api::grpc::solvio::CollectionConfig {
                ...
                strict_mode_config: config
                    .strict_mode_config
                    .map(api::grpc::solvio::StrictModeConfigDiff::from),
            }),
...
impl From<api::grpc::solvio::StrictModeConfigDiff> for StrictModeConfigDiff {
    fn from(value: api::grpc::solvio::StrictModeConfigDiff) -> Self {
        Self {
