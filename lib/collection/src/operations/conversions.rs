...
impl From<StrictModeConfig> for api::grpc::solvio::StrictModeConfig {
    fn from(value: StrictModeConfig) -> Self {
        api::grpc::solvio::StrictModeConfig {
...
impl From<api::grpc::solvio::StrictModeConfig> for StrictModeConfig {
    fn from(value: api::grpc::solvio::StrictModeConfig) -> Self {
        Self {
            enabled: value.enabled,
