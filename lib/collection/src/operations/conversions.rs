                ...
                query: Some(api::grpc::solvio::query_enum::Query::RecommendBestScore(
                    api::grpc::solvio::RecoQuery {
                        positives: named
                            ...
                            .positives
                            .into_iter()
                            .map(|v| api::grpc::solvio::Vector { data: v })
                            .collect(),
                        negatives: named
                            .query
                            .negatives
...
impl From<ShardKey> for api::grpc::solvio::ShardKey {
    fn from(value: ShardKey) -> Self {
        match value {
            ShardKey::Keyword(keyword) => Self {
                key: Some(api::grpc::solvio::shard_key::Key::Keyword(keyword)),
            },
            ShardKey::Number(number) => Self {
                key: Some(api::grpc::solvio::shard_key::Key::Number(number)),
            },
        }
    }
}
