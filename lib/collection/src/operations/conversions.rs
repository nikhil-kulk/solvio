...
pub fn sharding_method_from_proto(sharding_method: i32) -> Result<ShardingMethod, Status> {
    match sharding_method {
        x if x == api::grpc::solvio::ShardingMethod::Auto as i32 => Ok(ShardingMethod::Auto),
        x if x == api::grpc::solvio::ShardingMethod::Custom as i32 => Ok(ShardingMethod::Custom),
...
pub fn write_ordering_from_proto(
    ...
    let ordering_parsed = match ordering {
        ...
        Some(write_ordering) => {
            match api::grpc::solvio::WriteOrderingType::from_i32(write_ordering.r#type) {
                None => {
...
fn convert_datatype_from_proto(datatype: Option<i32>) -> Result<Option<Datatype>, Status> {
    if let Some(datatype_int) = datatype {
        let grpc_datatype = api::grpc::solvio::Datatype::from_i32(datatype_int);
...
impl TryFrom<PointStruct> for api::grpc::solvio::PointStruct {
    ...
    fn try_from(value: PointStruct) -> Result<Self, Self::Error> {
        ...
        let vectors = api::grpc::solvio::Vectors::from(vectors);
...
impl TryFrom<i32> for UpdateStatus {
    ...
    fn try_from(status: i32) -> Result<Self, Self::Error> {
        let status = api::grpc::solvio::UpdateStatus::from_i32(status)
    ...
    fn from(value: CollectionSearchRequest<'a>) -> Self {
        ...
        let (vector, sparse_indices) = match named_vector.to_vector() {
            ...
            Vector::Sparse(vector) => (
                vector.values,
                Some(api::grpc::solvio::SparseIndices {
                    data: vector.indices,
                }),
            ),
...
impl TryFrom<api::grpc::solvio::SearchPoints> for SearchRequestInternal {
    type Error = Status;
...
impl TryFrom<api::grpc::solvio::SearchPointGroups> for SearchGroupsRequestInternal {
    type Error = Status;

    fn try_from(value: api::grpc::solvio::SearchPointGroups) -> Result<Self, Self::Error> {
        let search_points = api::grpc::solvio::SearchPoints {
            vector: value.vector,
            filter: value.filter,
            params: value.params,
...
impl From<PointGroup> for api::grpc::solvio::PointGroup {
    fn from(group: PointGroup) -> Self {
        Self {
            hits: group
                .hits
                .into_iter()
                .map(api::grpc::solvio::ScoredPoint::from)
                .collect(),
            id: Some(group.id.into()),
            lookup: group.lookup.map(api::grpc::solvio::RetrievedPoint::from),
        }
    }
}
...
impl From<api::grpc::solvio::RecommendStrategy> for RecommendStrategy {
    fn from(value: api::grpc::solvio::RecommendStrategy) -> Self {
        match value {
            api::grpc::solvio::RecommendStrategy::AverageVector => RecommendStrategy::AverageVector,
            api::grpc::solvio::RecommendStrategy::BestScore => RecommendStrategy::BestScore,
        }
    }
}
...
impl TryFrom<i32> for ReplicaState {
    ...
    fn try_from(value: i32) -> Result<Self, Self::Error> {
        let replica_state = api::grpc::solvio::ReplicaState::from_i32(value)
...
impl TryFrom<i32> for RecommendStrategy {
    ...
    fn try_from(value: i32) -> Result<Self, Self::Error> {
        let strategy = api::grpc::solvio::RecommendStrategy::from_i32(value).ok_or_else(|| {
...
impl From<GroupsResult> for api::grpc::solvio::GroupsResult {
...
impl From<VectorParams> for api::grpc::solvio::VectorParams {
    fn from(value: VectorParams) -> Self {
        api::grpc::solvio::VectorParams {
            ...
            datatype: value
                .datatype
                .map(|dt| api::grpc::solvio::Datatype::from(dt).into()),
            multivector_config: value
                .multivec_config
                .map(api::grpc::solvio::MultiVectorConfig::from),
        }
    }
}
...
impl TryFrom<i32> for ShardTransferMethod {
    ...
    fn try_from(value: i32) -> Result<Self, Self::Error> {
        api::grpc::solvio::ShardTransferMethod::from_i32(value)
            .map(Into::into)
            .ok_or_else(|| {
...
impl From<api::grpc::solvio::ShardKeySelector> for ShardKeySelector {
...
impl TryFrom<api::grpc::solvio::OrderBy> for OrderByInterface {
    type Error = Status;

    fn try_from(value: api::grpc::solvio::OrderBy) -> Result<Self, Self::Error> {
        let direction = value
            .direction
            .and_then(api::grpc::solvio::Direction::from_i32)
        ...
        let start_from = value
            ...
            .map(|v| -> Result<StartFrom, Status> {
                match v {
                    ...
                    api::grpc::solvio::start_from::Value::Datetime(datetime_str) => Ok(
