...
pub mod from_grpc {
    ...
    use api::grpc::solvio::{self as grpc};
    use tonic::Status;

    use super::*;

    impl TryFrom<api::grpc::solvio::QueryPointGroups> for CollectionQueryGroupsRequest {
        type Error = Status;

        fn try_from(value: api::grpc::solvio::QueryPointGroups) -> Result<Self, Self::Error> {
    ...
    impl TryFrom<api::grpc::solvio::QueryPoints> for CollectionQueryRequest {
        type Error = Status;

        fn try_from(value: api::grpc::solvio::QueryPoints) -> Result<Self, Self::Error> {
