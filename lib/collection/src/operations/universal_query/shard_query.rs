...
impl TryFrom<i32> for Fusion {
    ...
    fn try_from(fusion: i32) -> Result<Self, Self::Error> {
        let fusion = api::grpc::solvio::Fusion::from_i32(fusion).ok_or_else(|| {
...
impl TryFrom<i32> for Sample {
    ...
    fn try_from(sample: i32) -> Result<Self, Self::Error> {
        let sample = api::grpc::solvio::Sample::from_i32(sample).ok_or_else(|| {
...
impl From<api::grpc::solvio::Fusion> for Fusion {
    fn from(fusion: api::grpc::solvio::Fusion) -> Self {
        match fusion {
            api::grpc::solvio::Fusion::Rrf => Fusion::Rrf,
            api::grpc::solvio::Fusion::Dbsf => Fusion::Dbsf,
        }
    }
}

impl From<Fusion> for api::grpc::solvio::Fusion {
    fn from(fusion: Fusion) -> Self {
        match fusion {
            Fusion::Rrf => api::grpc::solvio::Fusion::Rrf,
            Fusion::Dbsf => api::grpc::solvio::Fusion::Dbsf,
        }
    }
}

impl From<Sample> for api::grpc::solvio::Sample {
    fn from(value: Sample) -> Self {
        match value {
            Sample::Random => api::grpc::solvio::Sample::Random,
        }
    }
}

impl From<api::grpc::solvio::Sample> for Sample {
    fn from(value: api::grpc::solvio::Sample) -> Self {
        match value {
            api::grpc::solvio::Sample::Random => Sample::Random,
        }
    }
}
