...
use api::grpc::{DecayParamsExpression, solvio as grpc};
...
impl TryFrom<i32> for FusionInternal {
    ...
    fn try_from(fusion: i32) -> Result<Self, Self::Error> {
        let fusion = api::grpc::solvio::Fusion::try_from(fusion).map_err(|_| {
...
impl TryFrom<i32> for SampleInternal {
    ...
    fn try_from(sample: i32) -> Result<Self, Self::Error> {
        let sample = api::grpc::solvio::Sample::try_from(sample).map_err(|_| {
...
impl TryFrom<api::grpc::solvio::Formula> for FormulaInternal {
    type Error = tonic::Status;

    fn try_from(formula: api::grpc::solvio::Formula) -> Result<Self, Self::Error> {
        let api::grpc::solvio::Formula {
            expression,
            defaults,
        } = formula;
...
impl From<api::grpc::solvio::Fusion> for FusionInternal {
    fn from(fusion: api::grpc::solvio::Fusion) -> Self {
        match fusion {
            api::grpc::solvio::Fusion::Rrf => FusionInternal::Rrf,
            api::grpc::solvio::Fusion::Dbsf => FusionInternal::Dbsf,
        }
    }
}

impl From<FusionInternal> for api::grpc::solvio::Fusion {
    fn from(fusion: FusionInternal) -> Self {
        match fusion {
            FusionInternal::Rrf => api::grpc::solvio::Fusion::Rrf,
            FusionInternal::Dbsf => api::grpc::solvio::Fusion::Dbsf,
        }
    }
}

impl From<SampleInternal> for api::grpc::solvio::Sample {
    fn from(value: SampleInternal) -> Self {
        match value {
            SampleInternal::Random => api::grpc::solvio::Sample::Random,
        }
    }
}

impl From<api::grpc::solvio::Sample> for SampleInternal {
    fn from(value: api::grpc::solvio::Sample) -> Self {
        match value {
            api::grpc::solvio::Sample::Random => SampleInternal::Random,
        }
    }
}
...
impl From<QueryEnum> for grpc::RawQuery {
    fn from(value: QueryEnum) -> Self {
        use api::grpc::solvio::raw_query::Variant;
    ...
    fn from(value: ScoringQuery) -> Self {
        ...
        match value {
            ...
            ScoringQuery::Fusion(fusion) => Self {
                score: Some(Score::Fusion(api::grpc::solvio::Fusion::from(fusion) as i32)),
            },
            ...
            ScoringQuery::Sample(sample) => Self {
                score: Some(Score::Sample(api::grpc::solvio::Sample::from(sample) as i32)),
            },
        }
    }
}
