...
impl Issue for TooManyCollections {
    ...
    fn description(&self) -> String {
        "It looks like you have too many collections.\nIf your architecture creates collections programmatically, it's probably better to restructure your solution into a fixed number of them.\n\nLearn more here: https://solvio.tech/documentation/guides/multiple-partitions/\nOr, for some more complex cases: https://solvio.tech/documentation/guides/distributed_deployment/#user-defined-sharding".to_string()
    }

    fn solution(&self) -> Solution {
        Solution::Refactor(
            "Restructure your usage of Solvio into a fixed number of collections".to_string(),
        )
    }
}
