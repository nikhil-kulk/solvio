...
use api::grpc::solvio::RecoveryPointClockTag;
...
impl From<RecoveryPoint> for api::grpc::solvio::RecoveryPoint {
...
impl From<api::grpc::solvio::RecoveryPoint> for RecoveryPoint {
    fn from(value: api::grpc::solvio::RecoveryPoint) -> Self {
        Self {
            clocks: value
                .clocks
                .into_iter()
