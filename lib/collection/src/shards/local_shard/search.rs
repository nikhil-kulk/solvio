...
// See: <https://github.com/solvio/solvio/pull/813>
// See: <https://github.com/solvio/solvio/pull/6326>
...
impl LocalShard {
    pub async fn do_search(
        ...
        let skip_batching = if core_request.searches.len() <= CHUNK_SIZE {
            ...
            // Note: search threads are shared with all other search threads on this Solvio
            ...
            // See: <https://github.com/solvio/solvio/pull/6478>
            true
        } else {
            false
        };
