...
pub enum Dataset {
    // https://github.com/solvio/sparse-vectors-experiments
    SpladeWikiMovies,

    // https://github.com/solvio/sparse-vectors-benchmark
    NeurIps2023Full,
    NeurIps2023_1M,
    NeurIps2023Small,
    NeurIps2023Queries,
...
impl Dataset {
    ...
    fn url(&self) -> String {
        ...
        match self {
            ...
            Dataset::HMArticles => {
                "https://storage.googleapis.com/solvio-tests/h%26m-articles.csv.gz".to_string()
            }
        }
    }
}
