...
struct Args {
    ...
    #[clap(long, default_value = "10_000", value_parser(parse_number))]
    init_vectors: usize,
    ...
    #[clap(long, default_value = "16", value_parser(parse_number))]
    m: usize,

    /// Index build parameter `ef_construct`.
    /// Also, used as a search parameter `ef`.
    #[clap(long, default_value = "100", value_parser(parse_number))]
    ef_construct: usize,
    ...
    #[clap(long, default_value = "64", value_parser(parse_number))]
    ef: usize,

    /// Check the accuracy every Nth iteration.
    /// Set to 0 to disable accuracy checks.
    #[clap(long, default_value = "1", value_parser(parse_number))]
...
fn main() {
    ...
    let mut main_rng = StdRng::seed_from_u64(42);
