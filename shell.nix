# A nix-shell file that sets up a convenient environment to develop Solvio.
#
# It includes all necessary dependencies used to build and develop Solvio's Rust
...
mkShell {
  ...
  shellHook = ''
    ...
    # https://solvio.tech/documentation/guides/common-errors/#too-many-files-open-os-error-24
