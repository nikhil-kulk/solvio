...
use api::grpc::solvio::RecommendInput;
use api::grpc::solvio::query::Variant;
use api::grpc::{InferenceUsage, solvio as grpc};
use api::rest;
...
mod tests {
    ...
    use api::grpc::solvio::Value;
    use api::grpc::solvio::value::Kind;
    use api::grpc::solvio::vector_input::Variant;
    use collection::operations::point_ops::VectorPersisted;

    use super::*;

    fn create_test_document() -> api::grpc::solvio::Document {
        api::grpc::solvio::Document {
            text: "test".to_string(),
    ...
    fn create_test_image() -> api::grpc::solvio::Image {
        api::grpc::solvio::Image {
            image: Some(Value {
    ...
    fn create_test_object() -> api::grpc::solvio::InferenceObject {
        api::grpc::solvio::InferenceObject {
            object: Some(Value {
