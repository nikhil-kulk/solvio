from solvio_client import SolvioClient, grpc as qgrpc
import pytest
from solvio_client.conversions.conversion import payload_to_grpc
import os


solvio_HOST = os.environ.get("solvio_HOST", "localhost")
CLIENT = SolvioClient(prefer_grpc=True, timeout=3.0, host=solvio_HOST)
