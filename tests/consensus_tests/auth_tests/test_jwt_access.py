...
ACTION_ACCESS = {
    ...
    "query_points": EndpointAccess(
        True, True, True, "POST /collections/{collection_name}/points/query", "solvio.Points/Query"
    ),
    "query_batch_points": EndpointAccess(
        True, True, True, "POST /collections/{collection_name}/points/query/batch", "solvio.Points/QueryBatch"
    ),
    ...
    "search_points_matrix_offsets": EndpointAccess(
        ...
        "solvio.Points/SearchMatrixOffsets",
    ),
    "search_points_matrix_pairs": EndpointAccess(
        True,
        True,
        True,
        "POST /collections/{collection_name}/points/search/matrix/pairs", "solvio.Points/SearchMatrixPairs"
    ),
    "facet": EndpointAccess(
        True, True, True, "POST /collections/{collection_name}/facet", "solvio.Points/Facet"
    ),
    ### Service ###
