...
def test_consensus_compaction(tmp_path: pathlib.Path):
    ...
    env = {
        ...
        "solvio__CLUSTER__CONSENSUS__COMPACT_WAL_ENTRIES": "1",
    }
    ...
    # Failed before <https://github.com/solvio/solvio/pull/6014>
...
def test_consensus_compaction_shard_keys(tmp_path: pathlib.Path):
    ...
    Tests:
    - <https://github.com/solvio/solvio/pull/6209>
    - <https://github.com/solvio/solvio/pull/6212>
    """
