...
def setup(tmp_path_factory: pytest.TempPathFactory):
    extra_env = {
        "solvio__SERVICE__SLOW_QUERY_SECS": "0.001",   # "Always" try to trigger slow search issue
        "solvio__STORAGE__WAL__WAL_CAPACITY_MB": "1", # Speed up creating many collections
    }

    tmp_path = tmp_path_factory.mktemp("solvio")
