...
#
# It sets a very low limit and inserts some points. Solvio should dynamically
...
def test_max_segment_size(tmp_path: pathlib.Path):
    ...
    env={
        "solvio__STORAGE__OPTIMIZERS__DEFAULT_SEGMENT_NUMBER": "2",
        "solvio__STORAGE__OPTIMIZERS__MAX_SEGMENT_SIZE_KB": "1",
