...
def test_multi_vector_float_persisted():
    ...
    assert first_point['vector'] == [[0.05, 0.61, 0.76, 0.74], [0.05, 0.61, 0.76, 0.74],
                                     [0.05, 0.61, 0.76, 0.74]]
    ...
    assert point['id'] == 2
    assert point['vector'] == [[0.19, 0.81, 0.75, 0.11], [0.19, 0.81, 0.75, 0.11],
                               [0.19, 0.81, 0.75, 0.11]]
...
def test_upsert_legacy_api():
    ...
    assert point['id'] == 1
    assert point['vector'] == [[0.05, 0.61, 0.76, 0.74], [0.05, 0.61, 0.76, 0.74],
                               [0.05, 0.61, 0.76, 0.74]]
