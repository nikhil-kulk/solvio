...
#
# Read more here: https://github.com/solvio/solvio/blob/master/docs/DEVELOPMENT.md#rest
...
then
    ...
    echo "ERROR: See: https://github.com/solvio/solvio/blob/master/docs/DEVELOPMENT.md#rest"
    exit 1
fi
