...
Usage examples:
  ...
  python smaps-view.py $(pidof solvio) '.*/vector_index/.*'

  # Verbose mode - show individual files larger than 1MB
  python smaps-view.py $(pidof solvio) '.*/vector_storage/.*' -v
...
#
#
# 7de883800000-7de885800000 r--s 00000000 00:33 26610006                   /solvio/storage/collections/benchmark/0/segments/6250c760-ccaf-468e-a96f-8e2b03f8c524/vector_storage/vectors/chunk_2.mmap
# Size:              32768 kB
# KernelPageSize:        4 kB
# MMUPageSize:           4 kB
# Rss:                   0 kB
